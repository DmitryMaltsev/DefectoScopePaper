...
namespace DefectoScope
{
    public class SplitButton : Button
    {
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Возвращает или задает значение, указывающее, производятся ли изменения размеров элемента управления в соответствии
        ///     с его содержимым.
        /// </summary>
        /// <returns>
        ///     <see langword="true" /> Если элемент управления автоматически изменяет размер в зависимости от его содержимого; в
        ///     противном случае — <see langword="false" />.
